    ...
    <div id="main" class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div id="mainContent" class="col-lg-offset-1 col-lg-10 col-md-offset-1 col-md-10 col-sm-offset-0 col-sm-12 col-xs-offset-0 col-xs-12 p-none pt-xlg mt-lg">
                    ...
                    <div id="giftsRecommendation" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center p-none bg-mydark border-mydark">
                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-1 text-white pt-xlg pb-sm">
                            <h3>精<br/>品<br/>推<br/>荐</h3>
                        </div>
                        <div class="col-lg-11 col-md-11 col-sm-10 col-xs-11 p-none bg-grey">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 p-none animation-rotate ani-rotate">
                                <a class="" href="content/detail.jsp?pid=10">
                                    <img class="img-responsive" src="content/assets/images/photo/hero_large1.png">
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 p-none animation-rotate ani-rotate">
                                <a class="" href="content/detail.jsp?pid=12">
                                    <img class="img-responsive" src="content/assets/images/photo/hero_large2.jpg">
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 p-none animation-rotate ani-rotate">
                                <a class="" href="content/detail.jsp?pid=14">
                                    <img class="img-responsive" src="content/assets/images/photo/hero_large3.png">
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 p-none animation-rotate ani-rotate">
                                <a class="" href="content/detail.jsp?pid=6">
                                    <img class="img-responsive" src="content/assets/images/photo/hero_large4.jpg">
                                </a>
                            </div>
                        </div>
                    </div>
