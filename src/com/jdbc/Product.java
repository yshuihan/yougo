...
public class Product implements java.io.Serializable {
	...
	/** full constructor */
	public Product(String name, Short typeid, Float price,
			Float oldprice, String procode, String parameter,
			String groundingstate,String grounding, String undercarriage, String indeximage,
	...
	public Product(Short id, String name, Short typeid, Float price,
			Float oldprice, String procode, String parameter,
			String groundingstate,String grounding, String undercarriage, Long allocunt, Float discount) {
		this.id = id;
		this.name = name;
		this.typeid = typeid;
		this.price = price;
